...
public class JTreeFile implements TreeExpansionListener{
    ...
    public void init() {
        ...
        String rutaPoyecto [] = rootFile.getPath().split("\\\\");
        String directorio = rutaPoyecto[rutaPoyecto.length-1];
        ...
        //rootFile = new File("C:\\Users\\EduardoFlores\\Desktop\\Proyecto1\\Proyecto1");
